...
<g id="clouds" fill="#fefefe">
 ...
 {/*SCENE 2 */}
    <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" viewBox="0 0 750 500" preserveAspectRatio="xMidYMax slice">
    <defs>
          ...
          <g id="scene3" style={{visibility: "hidden"}}>
            ...
            <g id="fstar">
                ...
                <circle cx="768.6" cy="78.72" r="39.39" transform="translate(64.22 396.2) rotate(-30.11)"
                    fill="url(#fstar-grad)" style={{mixblendmode: "overlay"}} />
            </g>
            ...
            <g id="hills3">
                ...
                <polygon id="h3-5"
                    ...
                    fill="url(#linear-gradient)" style={{mixblendmode: "multiply", opacity:"50%"}}/>
                <path id="h3-4"
                    ...
                    fill="url(#linear-gradient-2)" style={{mixblendmode: "multiply", opacity:"70%"}} />
                <path id="h3-3"
                    ...
                    fill="url(#linear-gradient-3)" style={{mixblendmode: "multiply", opacity:"70%"}} />
                <path id="h3-2"
                    ...
                    fill="url(#linear-gradient-4)" style={{mixblendmode: "multiply", opacity:"70%"}}/>
                <path id="h3-1"
                style={{ opacity:"90%"}}
