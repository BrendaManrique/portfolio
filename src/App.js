          ...
          <g id="scene3" style={{visibility: "hidden"}}>
            ...
            <g id="hills3">
                ...
                <polygon id="h3-5"
                    ...
                    fill="url(#linear-gradient)" style={{mixBlendMode: "multiply"}}/>
                <path id="h3-4"
                    ...
                    fill="url(#linear-gradient-2)" style={{mixBlendMode: "multiply"}} />
                <path id="h3-3"
                    ...
                    fill="url(#linear-gradient-3)" style={{mixBlendMode: "multiply"}} />
                <path id="h3-2"
                    ...
                    fill="url(#linear-gradient-4)" style={{mixBlendMode: "multiply",}}/>
                <path id="h3-1"
                    style={{ opacity:"95%"}}
                    fill="#18132e"
